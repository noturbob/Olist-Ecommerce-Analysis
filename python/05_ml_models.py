...
print(f"✅ Loaded {len(delivery_data):,} delivery records")
...
plt.close()
print("\n✅ Saved: ml_models/01_delivery_confusion_matrix.png")
...
plt.close()
print("✅ Saved: ml_models/02_delivery_roc_curve.png")
...
plt.close()
print("✅ Saved: ml_models/03_delivery_feature_importance.png")
...
ax.set_title(f'Review Score Prediction (R² = {r2_rf:.3f})', fontsize=14, fontweight='bold')
ax.legend()
ax.grid(alpha=0.3)
plt.tight_layout()
plt.savefig('ml_models/04_review_actual_vs_predicted.png', dpi=300, bbox_inches='tight')
plt.close()
print("✅ Saved: ml_models/04_review_actual_vs_predicted.png")
...
plt.close()
print("✅ Saved: ml_models/05_review_feature_importance.png")
...
plt.close()
print("✅ Saved: ml_models/06_customer_segmentation.png")
